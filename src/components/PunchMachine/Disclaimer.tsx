...
const Disclaimer = ({ onAccept, onBack }: DisclaimerProps) => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 flex flex-col items-center justify-center text-white p-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl text-center animate-fade-in relative z-10">
        <h1 className="text-3xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-yellow-400">
          ⚠️ DISCLAIMER ⚠️
        </h1>
        
        <div className="bg-black/40 backdrop-blur-lg rounded-xl p-4 mb-4 text-left border border-gray-700 shadow-2xl">
        ...
        <div className="mb-4 bg-gray-800/50 backdrop-blur-sm rounded-xl p-3 border border-gray-600">
          <label className="flex items-center justify-center text-lg cursor-pointer group">
            <input 
              type="checkbox" 
              checked={accepted}
              onChange={(e) => setAccepted(e.target.checked)}
              className="w-8 h-8 mr-4 accent-red-500 cursor-pointer"
            />
        ...
        <div className="flex gap-4 justify-center">
          ...
          <Button 
            ...
            disabled={!accepted}
            size="lg"
            className="text-lg px-8 py-4 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-xl shadow-xl transform hover:scale-105 transition-all duration-200"
          >
            Accept & Continue →
          </Button>
        </div>
